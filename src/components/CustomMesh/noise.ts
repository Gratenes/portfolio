...
let noise: {
  ...
  simplex2: function (xin: number, yin: number): number {
  ...
  perlin2: function (x: number, y: number): number {
  ...
  simplex3: function (xin: number, yin: number, zin: number): number {
